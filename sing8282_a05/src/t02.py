...
source1 = Sorted_List()  # create List instance 1
source2 = Sorted_List()  # create List instance 2
...
source2.insert(movies[1])
source2.insert(movies[6])
source2.insert(movies[7])
...
target = Sorted_List()  # create another List instance
